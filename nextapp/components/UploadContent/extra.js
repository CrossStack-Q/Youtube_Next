...
function MainUp() {
  ...
  const [storageMail, setStorageMail] = useState("");
  ...
  const uploadThumbnail = async () => {
    ...
    const thumbnailRef = ref(
      storage,
      `youtubeq/storageMail/storageMail/document_id/thumbnail`
    );
        ...
        {selectedFile && (
          <div className="flex flex-col justify-center items-center p-4 pl-7 pr-7 md:min-w-[48rem] sm:min-w-[30rem] lg:min-w-[60rem] xl:min-w-[64rem] border-dashed border border-gray-600 rounded-3xl mt-8">
            {loading ? (
              ...
              <Button auto onClick={uploadVideo}>
                Upload
              </Button>
            )}
          </div>
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center p-4 pl-7 pr-7 md:min-w-[48rem] sm:min-w-[30rem] lg:min-w-[60rem] xl:min-w-[64rem] border-dashed border border-gray-600 rounded-3xl mt-8">
            {loadingthumbnail ? (
              ...
              <Button auto onClick={uploadThumbnail}>
                Upload
              </Button>
            )}
          </div>
